...
- Updated test dependencies (NSubstitute 6.2.0, xunit.v3.aot.mtp-v2 4.0.1, xunit.analyzers 2.1.0, FunFair.Test.Common 6.4.6, Microsoft.Extensions.TimeProvider.Testing 10.10.0) and added IncludeAssets to package references to satisfy the build checks
### Deprecated
### Removed

...
- Configuration documentation in `README.md` must always match the actual options classes (`GitHubOptions`, `DatabaseConfiguration`, etc.) and their validation rules.

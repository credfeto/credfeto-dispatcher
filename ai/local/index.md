...
| File | Covers |
| --- | --- |
| [database.instructions.md](database.instructions.md) | Database architecture rule (filter/order in SQL not C#), schema, stored procedures, migrations |
| [documentation.instructions.md](documentation.instructions.md) | README.md configuration documentation requirements |

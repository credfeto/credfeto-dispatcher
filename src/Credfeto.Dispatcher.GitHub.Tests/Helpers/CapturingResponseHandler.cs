...
internal sealed class CapturingResponseHandler : HttpMessageHandler
{
    private readonly string? _content;
    private readonly string? _eTag;
    private readonly HttpStatusCode _statusCode;

    public CapturingResponseHandler(HttpStatusCode statusCode, string? content = null, string? eTag = null)
    {
